...
| 跨平台 CI | [GitHub Actions 运行 #35215623739](https://github.com/hxiuzheng/media-pack-audit/actions/runs/35215623739)：PNG 全块 CRC / 结构校验提交的 Ubuntu 与 Windows job 均通过格式、无警告检查、原生测试和 CLI smoke | 已满足（该提交） |
